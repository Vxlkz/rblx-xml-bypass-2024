...
'''.strip().encode()
    ...
    def encrypt2(self):
        ...
        self.code = f'''# Obfuscated by LETH4L
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(prog=sys.argv[0], description="Obfuscates python program to make it so skids cant steal ur scripts.")
